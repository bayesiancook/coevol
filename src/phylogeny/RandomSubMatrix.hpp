...
// has some specific corrupt/update behaviors (just for computational efficiency
// reasons)
...
// class RandomTransitionMatrix : public virtual RandomAbstractTransitionMatrix,
// public virtual
