...
// thus we create a NucCodonSubMatrix, which takes a substitution matrix representing the nucleotide
...
// thus, for any codon model, you can immediately instantiate a projected aminoacid replacement
// process
