  ...
  public:
    RandomMGFitnessCodonSubMatrix(CodonStateSpace* instatespace, RandomSubMatrix* inmatrix,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          ...
          MGFitnessCodonSubMatrix(instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
                                  innormalise),
  ...
  public:
    RandomMGFitnessCodonUsageSubMatrix(CodonStateSpace* instatespace, RandomSubMatrix* inmatrix,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          CodonSubMatrix(instatespace, innormalise),
          RandomSubMatrix(instatespace->GetNstate(), innormalise),
          MGFitnessCodonUsageSubMatrix(instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
                                       inRandomCodonUsageSelection->GetArray(), innormalise),
          RandomCodonSubMatrix(instatespace, innormalise),
          matrix(inmatrix),
          RandomFitnessProfile(inRandomFitnessProfile),
  ...
  public:
    RandomMGSRFitnessNormalCodonUsageSubMatrix(CodonStateSpace* instatespace,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          CodonSubMatrix(instatespace, innormalise),
          RandomSubMatrix(instatespace->GetNstate(), innormalise),
          MGSRFitnessNormalCodonUsageSubMatrix(
              instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
              inRandomCodonUsageSelection->GetArray(), innormalise),
          RandomCodonSubMatrix(instatespace, innormalise),
          matrix(inmatrix),
          RandomFitnessProfile(inRandomFitnessProfile),
  ...
  public:
    RandomMGMSFitnessNormalCodonUsageSubMatrix(CodonStateSpace* instatespace,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          CodonSubMatrix(instatespace, innormalise),
          RandomSubMatrix(instatespace->GetNstate(), innormalise),
          MGMSFitnessNormalCodonUsageSubMatrix(
              instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
              inRandomCodonUsageSelection->GetArray(), innormalise),
          RandomCodonSubMatrix(instatespace, innormalise),
          matrix(inmatrix),
  ...
  public:
    RandomMGSRFitnessCodonUsageSubMatrix(CodonStateSpace* instatespace, RandomSubMatrix* inmatrix,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          CodonSubMatrix(instatespace, innormalise),
          RandomSubMatrix(instatespace->GetNstate(), innormalise),
          MGSRFitnessCodonUsageSubMatrix(instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
                                         inRandomCodonUsageSelection->GetArray(), innormalise),
          RandomCodonSubMatrix(instatespace, innormalise),
          matrix(inmatrix),
          RandomFitnessProfile(inRandomFitnessProfile),
  ...
  public:
    RandomMGMSFitnessCodonUsageSubMatrix(CodonStateSpace* instatespace, RandomSubMatrix* inmatrix,
        ...
        : SubMatrix(instatespace->GetNstate(), innormalise),
          CodonSubMatrix(instatespace, innormalise),
          RandomSubMatrix(instatespace->GetNstate(), innormalise),
          MGMSFitnessCodonUsageSubMatrix(instatespace, inmatrix, inRandomFitnessProfile->GetArray(),
                                         inRandomCodonUsageSelection->GetArray(), innormalise),
          RandomCodonSubMatrix(instatespace, innormalise),
          matrix(inmatrix),
          RandomFitnessProfile(inRandomFitnessProfile),
