...
//
//    The generalized Gauss-Hermite quadrature rule is computed using a 
//    relationship with the generalized Gauss-Laguerre quadrature rule.
//
//  Licensing:
//
...
//
{
  ...
  cout << "\n";
  cout << "  The user specifies ORDER, ALPHA, OPTION, and OUTPUT.\n";
  cout << "\n";
  cout << "  OPTION is:\n";
  cout << "\n";
  ...
  cout << "    are divided by |x|^ALPHA * exp(-x^2).\n";
  cout << "\n";
  cout << "  OUTPUT is:\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "  The requested ALPHA = " << alpha << "\n";
//
//  Get the option.
//
  if ( 3 < argc )
  ...
  else
  {
    ...
    cout << "      Integral ( -oo < x < +oo ) exp(-x^2) f(x) dx\n";
    cout << "\n";
...
//
  gen_hermite_handle ( order, alpha, option, output );
