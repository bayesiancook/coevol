...
template<class U> class MixValMove : public MCUpdate	{

	public:

	MixValMove(FiniteMixture<U>* inmix, double intuning, int innrep) : mix(inmix), tuning(intuning), nrep(innrep) {}
...
template<class U> class MixWeightAllocMove : public MCUpdate	{

	public:

	MixWeightAllocMove(FiniteMixture<U>* inmix, int innrep) : mix(inmix), nrep(innrep) {}
