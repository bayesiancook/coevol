#ifndef CONJUGATEDOLLOMODEL_H
#define CONJUGATEDOLLOMODEL_H
...
class ConjugateDolloModel : public ProbModel	{

	public:

	ConjugateDolloModel(string datafile, string treefile);
	...
	DolloRandomSubMatrix* matrix;

	ConjugateOneMatrixRASPhyloProcess* phyloprocess;

};

#endif // CONJUGATEDolloMODEL_H
