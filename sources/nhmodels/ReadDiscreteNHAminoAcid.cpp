...
class DiscreteNHAminoAcidSample : public Sample	{
	...
	// DiscreteNHAminoAcidModel* GetModel() {return (DiscreteNHAminoAcidModel*) model;}
	DiscreteNHAminoAcidModel* GetModel() {return (DiscreteNHAminoAcidModel*) model;}

	DiscreteNHAminoAcidSample(string filename, int inburnin, int inevery, int inuntil) : Sample(filename,inburnin,inevery,inuntil)	{
		Open();
	}
...
int main(int argc, char* argv[])	{
	...
	DiscreteNHAminoAcidSample sample(name,burnin,every,until);
	sample.Read();
