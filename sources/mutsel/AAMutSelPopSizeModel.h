...
class MatrixTree : public BranchValPtrTree<RandomMGMeanAAMutSelCodonSubMatrix>	{

	public:

	MatrixTree(CodonStateSpace* instatespace, RandomSubMatrix* innucmatrix, LengthTree* inpopsizetree) {
		SetWithRoot(true);
