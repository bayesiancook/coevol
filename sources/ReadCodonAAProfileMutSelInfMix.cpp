...
class CodonAAProfileMutSelInfMixSample : public Sample	{
	...
	CodonAAProfileMutSelInfMixSample(string filename, int inburnin, int inevery, int inuntil) : Sample(filename,inburnin,inevery,inuntil)	{
		Open();
	}
...
int main(int argc, char* argv[])	{
	...
	CodonAAProfileMutSelInfMixSample sample(name,burnin,every,until);
	if (postpred)	{
